...
//数据库核心程序路径
define( 'WECLU_INDEX_LEVEL', 4 ) ;

//索引级别
define( 'WECLU_IS_OPEN_THREAD', false ) ;

//是否开启多线程
define( 'WECLU_TABLE_FILE_MAX_BLOCKS', 157286400 ) ;

//数据表大小最大含有的文件快个数
define( 'WECLU_DATA_COLLECT_STAMP', 604800 ) ;

//数据回收时间 7天时间
define( 'WECLU_DATA_COLLECT_PERCENT', 0.1 ) ;
